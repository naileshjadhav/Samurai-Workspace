...
public interface SamuraiRpaRepository extends CrudRepository<SamuraiRpa, Long> {
	...
	Optional<SamuraiRpa> getSamuraiRpaByEformIdAndEformStatus(@Param("resolutionPlatform") String resolutionPlatform,@Param("eformStatusByPlatform") String eformStatusByPlatform);
